#!/usr/bin/env node
/**
 * Test VideoEngine integration in VideoAudioRecorder with Both Audio Sources
 * Records both desktop and microphone audio with VideoEngine clock master
 */
...
async function main() {
    const outputPath = path.join(__dirname, 'test_videoengine_both.mp4');

    console.log('═══════════════════════════════════════════════════════════');
    console.log('  Testing VideoEngine with Desktop + Microphone Audio');
    console.log('═══════════════════════════════════════════════════════════\n');
    ...
    try {
        ...
        console.log('🔧 Initializing VideoAudioRecorder with Both Audio Sources...');
        ...
        console.log('🔊 Audio Mode: Desktop + Microphone');
        ...
        if (fs.existsSync(outputPath)) {
            ...
            console.log(`📁 Output: ${outputPath}`);
            console.log('\n✅ Test PASSED - Both audio sources recorded successfully with VideoEngine!');
        } else {
